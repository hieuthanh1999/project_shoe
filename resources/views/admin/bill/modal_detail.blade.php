                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="name" class="form-control"
                                                        style="width: 200px;" placeholder="Type name of product"
                                                        disabled="" id="phoneInput">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select onchange='clickStatus()' name="status" id="config" class="form-control select2"
                                                            style="width: 200px;">
                                            ...
                                            <div id="error-message"
                                                style="margin-top: 5px; color: red; font-weight: bold; font-size: 13px;">
                                                Errors...
                                            </div>
                                ...
                                <table class="table table-hover middle-table-text" style="margin-top: 15px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="border: 1px solid #cccccc;">Product (Detail)
                                            </th>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="5"><b>Total: </b><a style="color: black;" id="totalInput"></a>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>

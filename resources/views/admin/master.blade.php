...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="{{route('admin.dashboard')}}" class="logo">
            ...
            <span class="logo-mini">Anna</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Anna Shop</b></span>
        </a>
   ...
   @include('admin.menu')
    ...
    <footer class="main-footer">
        <strong>FootWear Copyright &copy; 2021.</strong> All rights reserved. By <a href="#">Linh Thuy</a>
    </footer>

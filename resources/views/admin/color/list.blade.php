                    ...
                    <div class="box">
                        <div class="box box-solid box-primary">
                            <div class="box-header">
                                ...
                                <small>Hiển thị <b> {{count($listColor)}}</b> trên <b>{{count($listColor)}}</b> màu sắc</small>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                    ...
                                    <table class="table table-hover middle-table-text">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" class="text-center">Mã màu</th>
...
@section('footer')
    <script>
        ...
        $('.btnEdit').click(function(){
            ...
            $('#headerEdit').empty();
            $('#headerEdit').append('CHỈNH SỬA '+ value.name);

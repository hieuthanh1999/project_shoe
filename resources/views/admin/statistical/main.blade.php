...
<div class="content-wrapper">
            ...
            <div class="tab-content " style="margin-top: 25px;">
                <div id="">
                    ...
                    <div class="col-lg-4" style="text-align: left;">
                        ...
                        <p><i class="fa fa-square myclass{{$index}}"></i>{{' '.$item['name'].' ('.$item['value'].'%)'}}
                        </p>
                        @endforeach
                    </div>
                </div>
    ...
    <div class="row">
        <div id="" style="margin-top:30px;" class="">
            <div class="col-md-6">
                ...
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                    ...
                    <div class='col-sm-4'>
                        <div class="form-group">
                            <input type="date" name="kday" class="form-control" onchange="this.form.submit()" value="{{$kday}}">
                        </div>

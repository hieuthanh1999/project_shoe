...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                QUẢN LÝ DANH MỤC SẢN PHẨM &nbsp
                    ...
                    <div class="box">
                        <div class="box box-solid box-primary">
                            <div class="box-header">
                                <h3 class="box-title">DANH SÁCH DANH MỤC SẢN PHẨM CẤP 1</h3>
                                <small>Hiển thị <b>{{count($listCategoryParent)}}</b> trên <b>{{count($listCategoryParent)}}</b> danh mục sản phẩm cấp 1</small>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box box-solid box-primary">
                            <div class="box-header">
                                <h3 class="box-title">DANH SÁCH DANH MỤC SẢN PHẨM CẤP 2</h3>
                                <small>Hiển thị <b>{{count($listCategory)}}</b> trên <b>{{count($listCategory)}}</b> danh mục sản phẩm cấp 2</small>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="table table-hover middle-table-text">
                                        <thead>
                                            <tr>
                                                <th rowspan="2" class="text-center">Tên</th>
                                                <th rowspan="2" class="text-center">Danh mục cấp 1</th>
                                                <th rowspan="2" class="text-center">Hành động</th>
                                            </tr>
                                        </thead>
                                        <tbody>

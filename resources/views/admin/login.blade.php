...
<head><meta charset='UTF-8'><meta name="robots" content="noindex"><link rel="mask-icon" type="" href="//production-assets.codepen.io/assets/favicon/logo-pin-f2d2b6d2c61838f7e76325261b7195c27224080bc099486ddd6dccb469b8e8e6.svg" color="#111" /><link rel="canonical" href="https://codepen.io/frytyler/pen/EGdtg" />
	...
	* { -webkit-box-sizing:border-box; -moz-box-sizing:border-box; -ms-box-sizing:border-box; -o-box-sizing:border-box; box-sizing:border-box; }
	...
	.login h1 { color: #fff9; text-shadow: 0 0 10px rgba(0,0,0,0.3); letter-spacing:1px; text-align:center; }
    ...
    color: #fffdfd4f;">If you forget password or register, please contact me !!!</p>
		<form id="myForm">
			{{csrf_field()}}
			<input type="text" name="email" placeholder="Type your email or username" required="required" />
			<input type="password" name="password" placeholder="Type your password" required="required" />
			<div style="margin-bottom: 5px; color: red; font-style: italic; font-size: 13px; text-align: center;" id="errormes">
			</div>
	...
	$('form#myForm').submit(function (e) {
		...
		$.ajax({
			...
			success: function (res) {
				...
				if (res.code == 201) {
					$('#errormes').empty();
					$('#errormes').append('Wrong Information. Login Unsuccessfully');
				}
				...
				if (res.code == 200) {
					...
					$('#errormes').append('Login Successfully');
